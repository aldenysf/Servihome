...
<div class="contenedor">
    <div class="post">
        <form class="formulario" method="POST"  enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']);?>">
            ...
            <input class="" type="text" placeholder="Dirección" name="direccion" value="<?php echo $post['direccion'];?>" ><br>
            ...
            <textarea name="texto" placeholder="Descripción del problema" ><?php echo $post['texto'];?></textarea>
