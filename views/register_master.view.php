...
<header class="fixed">
    <div class="contenedor">
        <div class="logo izquierda">
            <p><a href="login_master.php">Servi Home</a></p>
        </div>
    </div>
</header>
...
<div class="contenedor">
    <div class="post">
        <form class="formulario" method="POST" name="register_costumer" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
          <div id="encabezado"><h1> Registrate como trabajador</h1> <a href="login_master.php" class="btn">Volver</a>   </div>
        ...
        <input class="" type="number" maxlength="12" placeholder="Telefono" name="telefono"><br>
