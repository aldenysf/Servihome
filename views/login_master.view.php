...
<head>
    ...
    <title>Inicio de Sesión trabajador</title>
</head>
<header class="fixed">
...
<div class="contenedor">
    <div class="post">
        <form class="formulario" method="POST" name="login" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
             <h1> <i class="fa fa-briefcase fa-2x" aria-hidden="true"></i> Inicia Sesión como Trabajador</h1>
        ...
        <h3>Para ingresar como un cliente, <a href="login.php">pincha aquí</a></h3>
        <h5>¿Aun no estas registrado como trabajador? <a href="register_master.php">Registrate</a></h5>
