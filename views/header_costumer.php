...
<header>
    <div class="contenedor">
        ...
        <div class="derecha">
            ...
            <nav class="menu">
                <ul>
                    <li><a href="costumer_serviciosActuales.php" >Servicios Actuales</a></li>
                    <li><a href="costumer_solicitud.php" >Solicitudes</a></li>
                    <li><a href="costumer_user.php" >Tus Post</a></li>
